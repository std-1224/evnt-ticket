            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value: 'buyer' | 'scanner' | 'admin') =>
                  ...
                  <SelectContent>
                    <SelectItem value="buyer">
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-muted-foreground">Comprar tickets y asistir a eventos</span>
                      </div>
                    </SelectItem>
                    <SelectItem value="scanner">
                      <div className="flex flex-col">
                        <span className="font-medium">Escáner</span>
                        <span className="text-xs text-muted-foreground">Escanear códigos QR en eventos</span>
                      </div>
                    </SelectItem>
                    <SelectItem value="admin">
                      <div className="flex flex-col">
                        <span className="font-medium">Administrador</span>
                        <span className="text-xs text-muted-foreground">Crear y gestionar eventos</span>
                      </div>
                    </SelectItem>
                  </SelectContent>
                </Select>
